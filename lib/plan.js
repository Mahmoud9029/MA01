...
export const ALTERNATIVES = {
  chest: ["Brustpresse (Maschine)", "Bankdrücken Langhantel", "Bankdrücken Kurzhantel", "Liegestütze", "Cable Crossover"],
  fly: ["Butterfly / Pec-Deck", "Kurzhantel-Flys", "Cable Flys (hoch/tief)"],
  lat: ["Latzug breit (Maschine)", "Latzug eng (Untergriff)", "Klimmzugmaschine (assistiert)", "Klimmzüge (frei)"],
  row: ["Rudern am Kabel (sitzend)", "Rudern vorgebeugt Langhantel", "Einarmiges Kurzhantelrudern", "T-Bar Rudern"],
  shoulder: ["Schulterdrücken Maschine", "Schulterdrücken Kurzhantel", "Military Press Langhantel", "Seitheben Kurzhantel", "Frontheben am Kabel"],
  leg: ["Beinpresse", "Kniebeugen (Langhantel)", "Goblet Squats Kurzhantel", "Ausfallschritte Kurzhanteln", "Rumänisches Kreuzheben"],
  curl: ["Bizeps-Curls Maschine", "Bizeps-Curls Langhantel", "Bizeps-Curls Kurzhantel", "Hammer-Curls", "Konzentrationscurls"],
  tricep: ["Trizeps-Seildrücken (Kabel)", "Enges Bankdrücken", "Kickbacks Kabel", "Dips-Maschine"],
  dip: ["Dips-Maschine (assistiert)", "Dips (frei)", "Enges Bankdrücken"],
  calf: ["Wadenheben Maschine", "Wadenheben mit Kurzhantel", "Wadenheben stehend"],
  ab: ["Plank", "Bauchmaschine / Cable Crunch", "Hanging Leg Raises", "Russian Twists"],
  cardio: ["Crosstrainer", "Rudergerät", "Radfahren (Intervall)", "Stepper", "Laufband"],
  dumbbell: ["Face Pulls (Kabel)", "Reverse Flys"],
};
